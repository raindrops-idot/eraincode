...
## 工具及介绍
工具主要有Ruby、msys2、jiekyll、github pages，之间的关系如图。![](https://raindrops-idot.github.io/imgs/eraincode/jekyll.png)   
下面分别进行介绍。
...
```
博客目录结构如下：
![](https://raindrops-idot.github.io/imgs/eraincode/jekyll-2.jpg)
...
![](https://raindrops-idot.github.io/imgs/eraincode/jekyll-5.jpg)
然后一直往下拉找到github pages进行如图的配置
![](https://raindrops-idot.github.io/imgs/eraincode/jekyll-6.jpg)
